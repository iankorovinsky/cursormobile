...
async function getStoredUser(context) {
    const userInfo = context.globalState.get(USER_STORAGE_KEY);
    return userInfo || null;
}
async function storeUser(context, user, accessToken) {
...
async function clearStoredUser(context) {
        ...
        switch (message?.type) {
            ...
            case 'login': {
                ...
                try {
                    ...
                    const auth0Client = new auth0_client_1.Auth0Client(auth0Config);
